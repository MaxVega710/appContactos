...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initComponents(){
        ...
        this.cbkFavorito = findViewById(R.id.cbxFavorito);
                ...
                case R.id.btnGuardar:
                    ...
                    if (completo) {
                        ...
                        if(savedContacto == null){
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Contacto actualizado con exito", Toast.LENGTH_SHORT).show();
                            limpiar();
                            break;
                            case R.id.btnListar:
...
//actualizar un objeto al nodo referencia
            ...
            public void actualizarContacto(String id, Contactos p) {
                //actualizar un objeto p.set_ID(id);
                referencia.child(String.valueOf(id)).setValue(p);
            }
            public boolean isNetworkAvailable() {
